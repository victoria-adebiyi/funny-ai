...
if __name__ == "__main__":
    ...
    train_loader = DataLoader(train_dataset, batch_size=64, shuffle=True)  # Adjusted batch size
    test_loader = DataLoader(test_dataset, batch_size=64, shuffle=False)  # Adjusted batch size

    # Initialize the enhanced regression model
    joke_regressor = ImprovedJokeRegressor(input_dim=768)
    joke_regressor.apply(init_weights)
